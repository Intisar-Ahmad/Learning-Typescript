...
class Person{
    static count = 1;//static members are shared across all instances of the class
    constructor(public name:string){
...
//abstract classes and methods
 ...
 abstract class Payment{// abstract class
   ...
   abstract isPaymentAllowed(amount :number):boolean;
}
...
class Paytm extends Payment{
    ...
    isPaymentAllowed(amount:number){
